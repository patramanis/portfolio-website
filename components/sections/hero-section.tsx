    ...
    <section className="min-h-screen flex flex-col relative overflow-hidden">
      ...
      <div className="relative z-10 flex-1 flex items-center w-full">
        <div className="flex w-full h-full">
          {/* Left side (50%) - Profile Image centered vertically */}
          <div className="w-1/2 flex items-center justify-center px-6 pt-12 pb-24">
            <div className="relative flex items-center justify-center">
              ...
              {/* Floating Clouds - Positioned at top edges of image */}
              <div className="absolute -top-16 left-0 w-full h-full pointer-events-none overflow-visible z-20">
                <FloatingClouds />
              </div>
            </div>
          </div>
          ...
          <div className="w-1/2 flex flex-col relative justify-between px-6 pt-12 pb-24">
            <div className="flex flex-col gap-0">
              {/* "Hi, I am Thomas" - Single line, smaller font */}
              <div className="mb-12">
              ...
              {/* "Welcome to my website" - Precise layout */}
              <div className="relative mb-12" style={{ minHeight: "240px" }}>
                {/* Welcome - Left */}
                ...
                {/* to - Right of Welcome, same line */}
                <div className="absolute left-0 top-0" style={{ marginLeft: "340px" }}>
                ...
                {/* my - Below Welcome, slightly left */}
                <div className="absolute left-0" style={{ top: "90px", marginLeft: "-10px" }}>
                  <span className="font-display text-3xl font-bold leading-none" style={{ background: "linear-gradient(135deg, #a1a1a1, #5a5a5a)", WebkitBackgroundClip: "text", WebkitTextFillColor: "transparent", backgroundClip: "text" }}>
                    my
                  </span>
                </div>

                {/* website - Right of my, below Welcome */}
                <div className="absolute left-0" style={{ top: "90px", marginLeft: "110px" }}>
                  <ParticleText text="website" fontSize={120} />
                </div>
              </div>

              {/* Subheadline - Below with proper spacing */}
              <p className="text-base md:text-lg text-zinc-500 max-w-3xl leading-relaxed">
                I am an applied informatics graduate, with strong interest in data science and quantitative finance.
              </p>
            </div>

            {/* "More about me" - Positioned at bottom center of right side */}
